...
inputs = {
  ...
  # 🔐 Certificado (opcional, se puede dejar null al inicio)
  certificate_name     = "precredit-ssl"
  certificate_pfx_path = null
  certificate_password = null

  # 🔑 Application Gateway Identity (si lo integras)
  application_gateway_identity_principal_id = null
